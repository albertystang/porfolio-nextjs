                ...
                <div className="flex items-center">
                  <Link href="/">
                    <h1 className="text-2xl font-medium">
                      Albert <span className="text-teal-500">Tang</span>
                    </h1>
                  </Link>
                </div>
                  ...
                  <Link
                    ...
                    className={`${
                      pathname === "/"
                        ...
                        : "border-transparent text-gray-500 dark:text-gray-300 hover:text-teal-500 dark:hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                    }`}
                  >
                    Home
                  </Link>
