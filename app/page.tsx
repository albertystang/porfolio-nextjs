...
import Me from '@/public/teddy-bear.jpg'
    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          />
          <h3 className="pt-4 pb-2 text-2xl font-bold leading-8 tracking-tight">Albert Tang</h3>
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Hey my name is Albert and I am a Web Page developing hobbyist
          </p>
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          <p>
            Hey everyone my name is Albert, I am 62 years old and I am a Full Stack
            developing hobbyist in Hong Kong.
          </p>
          <p>
